    ...
    public abstract class MonoSingleton<T> : MonoBehaviour where T : MonoBehaviour
    {
        ...
        public static T Instance
        {
            get
            {
                ...
                {
                    // LogManager.WriteLog (LogManager.LogType.Warning, "[MonoSingleton] Instance '"+ typeof(T) +
                ...
                lock (_lock)
                {
                    if (_instance == null)
                    {
                        ...
                        {
                            // LogManager.WriteLog (LogManager.LogType.Error, "[MonoSingleton] Something went really wrong " +
                ...
                lock (_lock)
                {
                    if (_instance == null)
                    {
                        ...
                        if (_instance == null)
                        {
                            GameObject singleton = new GameObject();
                            _instance = singleton.AddComponent<T>();
                            singleton.name = "(PersistantMonoSingleton) " + typeof(T).ToString();
